...
jsPsych.plugins['image-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    display_element.innerHTML = '<style id="jspsych-image-multi-choice-css"></style>';
    var cssstr = ".jspsych-image-multi-choice-question { margin-top: 2em; margin-bottom: 2em; text-align: left; }"+
      ".jspsych-image-multi-choice-text span.required {color: darkred;}"+
      ".jspsych-image-multi-choice-horizontal .jspsych-image-multi-choice-text {  text-align: center;}"+
      ".jspsych-image-multi-choice-option { line-height: 2; }"+
      ".jspsych-image-multi-choice-horizontal .jspsych-image-multi-choice-option {  display: inline-block;  margin-left: 1em;  margin-right: 1em;  vertical-align: top;}"+
      "label.jspsych-image-multi-choice-text input[type='radio'] {margin-right: 1em;}"

    display_element.querySelector('#jspsych-image-multi-choice-css').innerHTML = cssstr;

    // show stimulus
    display_element.innerHTML += '<center>' +
    '<img id="jspsych-image-multi-choice-stimulus" class="jspsych-image-multi-choice-stimulus" src="'+trial.stimulus+'"></img>'+
    '</center>';
    ...
    for (var i = 0; i < trial.questions.length; i++) {
        ...
        // add question text
        display_element.querySelector(question_selector).innerHTML += '<p class="' + plugin_id_name + '-text image-multi-choice">' + trial.questions[i].prompt + '</p>';
